...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.confirmation_token'
        db.add_column(u'chores_user', 'confirmation_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.confirmation_token'
        db.delete_column(u'chores_user', 'confirmation_token')
    ...
    models = {
        ...
        u'chores.chore': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'chores.housememberrequest': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'house': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invites'", 'to': u"orm['chores.House']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sent_invites'", 'to': u"orm['chores.User']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invites'", 'to': u"orm['chores.User']"})
        },
        u'chores.reminder': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 0, 0)'}),
        ...
        u'chores.user': {
            ...
            'confirmation_token': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
            'confirmed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
