...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'chores_user', 'timezone',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'chores_user', 'timezone')
    ...
    models = {
        ...
        u'chores.reminder': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 8, 0, 0)'}),
