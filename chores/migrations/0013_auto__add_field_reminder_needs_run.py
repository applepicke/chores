...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reminder.needs_run'
        db.add_column(u'chores_reminder', 'needs_run',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reminder.needs_run'
        db.delete_column(u'chores_reminder', 'needs_run')
    ...
    models = {
        ...
        u'chores.reminder': {
            ...
            'chore': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'reminders'", 'symmetrical': 'False', 'to': u"orm['chores.Chore']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 13, 0, 0)'}),
