...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.email_enabled'
        db.add_column(u'chores_user', 'email_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'User.sms_enabled'
        db.add_column(u'chores_user', 'sms_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.sms_verified'
        db.add_column(u'chores_user', 'sms_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.email_enabled'
        db.delete_column(u'chores_user', 'email_enabled')

        # Deleting field 'User.sms_enabled'
        db.delete_column(u'chores_user', 'sms_enabled')

        # Deleting field 'User.sms_verified'
        db.delete_column(u'chores_user', 'sms_verified')
