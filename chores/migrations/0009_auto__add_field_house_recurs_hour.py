...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'House.recurs_hour'
        db.add_column(u'chores_house', 'recurs_hour',
                      self.gf('django.db.models.fields.CharField')(default='0:00', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'House.recurs_hour'
        db.delete_column(u'chores_house', 'recurs_hour')
