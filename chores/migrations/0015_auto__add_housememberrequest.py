...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HouseMemberRequest'
        db.create_table(u'chores_housememberrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sent_email_requests', to=orm['chores.User'])),
            ('to_email', self.gf('django.db.models.fields.CharField')(default='', max_length=1025)),
            ('house', self.gf('django.db.models.fields.related.ForeignKey')(related_name='email_requests', to=orm['chores.House'])),
            ('confirmed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'chores', ['HouseMemberRequest'])


    def backwards(self, orm):
        # Deleting model 'HouseMemberRequest'
        db.delete_table(u'chores_housememberrequest')
    ...
    models = {
        ...
        u'chores.housememberrequest': {
            ...
            'to_email': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1025'})
        },
        u'chores.reminder': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 20, 0, 0)'}),
