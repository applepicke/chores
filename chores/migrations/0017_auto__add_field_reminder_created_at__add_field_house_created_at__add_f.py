...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'chores_reminder', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 7, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'House.created_at'
        db.add_column(u'chores_house', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 7, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'HouseMemberRequest.created_at'
        db.add_column(u'chores_housememberrequest', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 7, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'User.created_at'
        db.add_column(u'chores_user', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 7, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'Chore.created_at'
        db.add_column(u'chores_chore', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 7, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'chores_reminder', 'created_at')

        # Deleting field 'House.created_at'
        db.delete_column(u'chores_house', 'created_at')

        # Deleting field 'HouseMemberRequest.created_at'
        db.delete_column(u'chores_housememberrequest', 'created_at')

        # Deleting field 'User.created_at'
        db.delete_column(u'chores_user', 'created_at')

        # Deleting field 'Chore.created_at'
        db.delete_column(u'chores_chore', 'created_at')
    ...
    models = {
        ...
        u'chores.chore': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'chores.reminder': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 7, 0, 0)'}),
