...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chore.description'
        db.alter_column(u'chores_chore', 'description', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))

    def backwards(self, orm):

        # Changing field 'Chore.description'
        db.alter_column(u'chores_chore', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=2000))
